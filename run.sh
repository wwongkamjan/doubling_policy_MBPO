...
srun bash -c "hostname; python3 main_mbpo.py --env_name 'Hopper-v2' --num_epoch 100 --model_type 'pytorch' --exploration True --save_dir 'exploration' --exp_name 'explo_base_0'"
